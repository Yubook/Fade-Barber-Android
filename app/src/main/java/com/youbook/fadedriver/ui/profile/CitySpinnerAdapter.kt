...
class CitySpinnerAdapter(private val context: Context,private val stateList: List<ResultItem?>) : BaseAdapter() {
    ...
    override fun getView(position: Int, p1: View?, p2: ViewGroup?): View {
        val view = inflater!!.inflate(com.youbook.fadedriver.R.layout.item_spinner, null)
        val tv = view.findViewById<TextView>(com.youbook.fadedriver.R.id.tvSpinnerName)
