...
import com.youbook.fadedriver.databinding.ActivityCodeVerifyBinding
import com.youbook.fadedriver.extension.hideKeyboard
import com.youbook.fadedriver.extension.snackBar
...
import com.youbook.fadedriver.ui.profile.ResultNew
...
import com.youbook.fadedriver.utils.Utils.enable
                                ...
                                if (it.value.result.roleId == 2) {
                                    when {
                                        ...
                                        it.value.result.maxRadius!!.isEmpty() -> {
                                            ...
                                            var intent = Intent(this, com.youbook.fadedriver.MainActivity::class.java)
                                            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                                            startActivity(intent)
                                            finish()
                                        }
